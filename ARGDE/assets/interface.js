...
generate.frequency = function(res)
{
  ...
  switch(res)
  {
    ...
    case 'hour':
      chartDimensions.frequency.width = intervals.length * 80;
      chartDimensions.frequency.height = 600;
      break;

    case 'day' :
      chartDimensions.frequency.width = intervals.length * 100;
      chartDimensions.frequency.height = 600;
      break;
  }
...
generate.sentiment = function(res)
{
  ...
  switch(res)
  {
    ...
    case 'hour':
      chartDimensions.sentiment.width = intervals.length * 80;
      chartDimensions.sentiment.height = 600;
      break;

    case 'day':
      chartDimensions.sentiment.width = intervals.length * 100;
      chartDimensions.sentiment.height = 600;
      break;
  }
...
generate.class = function(res)
{
  ...
  switch(res)
  {
    ...
    case 'hour':
      chartDimensions.class.width = intervals.length * 80;
      chartDimensions.class.height = 600;
      break;

    case 'day' :
      chartDimensions.class.width = intervals.length * 100;
      chartDimensions.class.height = 600;
      break;
  }
...
generate.damage = function(res)
{
  ...
  switch(res)
  {
    ...
    case 'hour':
      chartDimensions.damage.width = intervals.length * 80;
      chartDimensions.damage.height = 600;
      break;

    case 'day':
      chartDimensions.damage.width = intervals.length * 100;
      chartDimensions.damage.height = 600;
      break;
  }
...
generate.relevancy = function(res)
{
  ...
  switch(res)
  {
    ...
    case 'hour':
      chartDimensions.relevancy.width = intervals.length * 80;
      chartDimensions.relevancy.height = 600;
      break;

    case 'day':
      chartDimensions.relevancy.width = intervals.length * 100;
      chartDimensions.relevancy.height = 600;
      break;
  }
